...
export class CreateCardComponent implements OnInit {
  ...
  BlockchainsDropDown = [
    ...
    },
    {
      ...
      id: 'BSC',
      contractAddress: environment.nftAddressBSC,
    },
  ...
  constructor(
    ...
    private readonly digitrackService: DigiTrackService,
  ...
  async loadData(){
    console.log("Loading Data");
     ...
     this.checkIfDigiSafe();
     this.setWalletReceiver(); 
  }
  ...
  async checkIfDigiSafe(){
    this.userAddress = await this.wallet.getAccount();

    if(this.userAddress) {
      this.isDigisafe = await this.digitrackService.isWalletDigiSafe(this.userAddress)
            
    }
    console.log(this.userAddress, "Is DigiSafge?", this.isDigisafe);

  }
  async setWalletReceiver(newAddress?: string) {
    if(newAddress){
      this.walletReceiver = newAddress;
    } else{
  ...
  async create(): Promise<void> {
      ...
      console.log(this.walletReceiver );
