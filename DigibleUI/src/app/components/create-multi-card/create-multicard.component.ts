...
@Component({
  selector: 'app-create-multicard',
  templateUrl: './create-multicard.component.html',
  styleUrls: ['./create-multicard.component.scss'],
  encapsulation: ViewEncapsulation.None,
})

export class CreateMultiCardComponent implements OnInit {
